...
public class QuerySelectPresenter implements QuerySelectContract.Presenter,OnStringListener {
    public static final String TAG = "QuerySelectPresenter";

    private QuerySelectContract.View view;
    private Context context;
    private StringModelImpl model;
    private ArrayList<QuerySelect> queryList = new ArrayList<>();

    public QuerySelectPresenter(Context context, QuerySelectContract.View view) {
