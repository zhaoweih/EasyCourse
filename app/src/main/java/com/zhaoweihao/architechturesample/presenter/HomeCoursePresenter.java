 ...
 */
public class HomeCoursePresenter implements HomeCourseContract.Presenter, OnStringListener {
    private Context context;

    private HomeCourseContract.View view;
    ...
    public HomeCoursePresenter(Context context, HomeCourseContract.View view) {
    ...
    public void onSuccess(String payload) {
        ...
        if (checkIsStu()) {
            try {
                ...
                //queryList.addAll(new Gson().fromJson(payload, new TypeToken<List<QuerySelect>>() {}.getType()));
            ...
            try {
                ...
                //queryTeacherList.addAll(new Gson().fromJson(payload, new TypeToken<List<Query>>() {}.getType()));
                Log.v("ok",""+payload);
                List<Query> queryList=new ArrayList<>();
                queryList=JSON.parseArray(payload,Query.class);
                queryTeacherList.addAll(queryList);
