...
/**
 * @author tanxinkui
 * @description 用于查询学生/老师课程信息之后，展示资源信息
 * @time 2019/1/23 14:24
 */
public class HomeResourcePresenter implements HomeResourceContract.Presenter, OnStringListener {
    private Context context;

    private HomeResourceContract.View view;
    ...
    public HomeResourcePresenter(Context context, HomeResourceContract.View view) {
