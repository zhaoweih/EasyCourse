...
public class HomeCourseMoreLeaveListAdapter extends RecyclerView.Adapter<HomeCourseMoreLeaveListAdapter.LeaveListViewHolder>{
    ...
    public HomeCourseMoreLeaveListAdapter(Context context, ArrayList<Leave> list) {
    ...
    @Override
    public HomeCourseMoreLeaveListAdapter.LeaveListViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new LeaveListViewHolder(inflater.inflate(R.layout.leave_layout,parent,false),listener,longClickListener);
    }

    @Override
    public void onBindViewHolder(HomeCourseMoreLeaveListAdapter.LeaveListViewHolder holder, int position) {
