...
public class HomeCourseTaskTalkTopicQueryAdapter extends RecyclerView.Adapter<HomeCourseTaskTalkTopicQueryAdapter.QueryViewHolder>{
    ...
    public HomeCourseTaskTalkTopicQueryAdapter(Context context, ArrayList<QueryTopic> list, Boolean checkTecOrStu) {
    ...
    @Override
    public HomeCourseTaskTalkTopicQueryAdapter.QueryViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new HomeCourseTaskTalkTopicQueryAdapter.QueryViewHolder(inflater.inflate(R.layout.query_topic_list_layout,parent,false),listener,longClickListener);
    }

    @Override
    public void onBindViewHolder(HomeCourseTaskTalkTopicQueryAdapter.QueryViewHolder holder, int position) {
