...
public class HomeRecommandAdapter extends BaseQuickAdapter<RecommandCourse,BaseViewHolder> {
    public HomeRecommandAdapter( @Nullable List<RecommandCourse> data) {
        super(R.layout.layout_home_course, data);
    }

    @Override
    protected void convert(BaseViewHolder viewHolder, RecommandCourse item) {
