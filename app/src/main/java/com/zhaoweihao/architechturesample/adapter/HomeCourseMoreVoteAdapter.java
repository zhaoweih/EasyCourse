...
public class HomeCourseMoreVoteAdapter extends RecyclerView.Adapter<HomeCourseMoreVoteAdapter.VoteListViewHolder>{
    ...
    public HomeCourseMoreVoteAdapter(Context context, ArrayList<Add> list) {
    ...
    @Override
    public HomeCourseMoreVoteAdapter.VoteListViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new VoteListViewHolder(inflater.inflate(R.layout.vote_item,parent,false),listener,longClickListener);
    }

    @Override
    public void onBindViewHolder(HomeCourseMoreVoteAdapter.VoteListViewHolder holder, int position) {
