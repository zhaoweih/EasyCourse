...
public class HomeCourseMoreVoteResultAdapter extends RecyclerView.Adapter<HomeCourseMoreVoteResultAdapter.ResultListViewHolder>{

    private static final String TAG = "HomeCourseMoreVoteResultAdapter";
    ...
    public HomeCourseMoreVoteResultAdapter(Context context, List<Select> list) {
    ...
    @Override
    public HomeCourseMoreVoteResultAdapter.ResultListViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ResultListViewHolder(inflater.inflate(R.layout.result_item,parent,false),listener,longClickListener);
    }

    @Override
    public void onBindViewHolder(HomeCourseMoreVoteResultAdapter.ResultListViewHolder holder, int position) {
    ...
    private void initNewBarDatas(HomeCourseMoreVoteResultAdapter.ResultListViewHolder holder, Select select) {
