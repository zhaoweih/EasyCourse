...
public class HomeCourseMoreCallRollSeatRecAdapter extends RecyclerView.Adapter<HomeCourseMoreCallRollSeatRecAdapter.SeatRecViewHolder>{
    ...
    public HomeCourseMoreCallRollSeatRecAdapter(Context context, ArrayList<Record> list) {
    ...
    @Override
    public HomeCourseMoreCallRollSeatRecAdapter.SeatRecViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new SeatRecViewHolder(inflater.inflate(R.layout.seat_rec_layout,parent,false),listener,longClickListener);
    }

    @Override
    public void onBindViewHolder(HomeCourseMoreCallRollSeatRecAdapter.SeatRecViewHolder holder, int position) {
