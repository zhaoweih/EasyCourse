...
/**
*@description 首页-课程-详细界面-更多-投票-去投票
*@author
*@time 2019/1/28 13:01
*/
public class HomeCourseMoreVoteToVoteActivity extends BaseActivity {

    public static final String TAG = "HomeCourseMoreVoteToVoteActivity";
    ...
    private void addRecord() {
        String suffix = Constant.READ_AND_VOTE_URL;
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                runOnUiThread(() -> {
                    if (restResponse.getCode() == Constant.SUCCESS_CODE) {
                        Toast.makeText(HomeCourseMoreVoteToVoteActivity.this, "提交投票成功", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                });
