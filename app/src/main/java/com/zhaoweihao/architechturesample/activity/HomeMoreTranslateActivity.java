...
import com.zhaoweihao.architechturesample.bean.translate.Translate;
import com.zhaoweihao.architechturesample.tools.Constant;
...
public class HomeMoreTranslateActivity extends BaseActivity {
    ...
    private TitleLayout cm_title;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_home_more_translate);
    ...
    private void initViews(){
        ...
        cm_title=findViewById(R.id.cm_title);
        cm_title.setTitle("翻译君");
