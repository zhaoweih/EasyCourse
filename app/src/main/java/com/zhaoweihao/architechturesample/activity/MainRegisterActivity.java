...
public class MainRegisterActivity extends BaseActivity implements View.OnClickListener {
    @BindView(R.id.ar_titleLayout)
    TitleLayout ar_titleLayout;
    private Button submitRegister;
    @BindView(R.id.input_question)
    GetInputTextOrSelectTagDialogLayout input_question;
    @BindView(R.id.input_answer)
    GetInputTextOrSelectTagDialogLayout input_answer;
    private static final Class thisClass = MainRegisterActivity.class;
    ...
    private void submitFinalRegisterInfo() {
        if (ed_username.getText().toString().equals("") || ed_password.getText().toString().equals("") || ed_passwordconfirm.getText().toString().equals("")) {
            ...
            if (tv_position.getText().toString().equals("学生")) {
                if (et_studentnum.getText().toString().equals("") || et_classnum.getText().toString().equals("") || et_name.getText().toString().equals("")) {
                    ...
                    if (input_answer.ifAlready() && input_question.ifAlready()) {
                        AlertDialog alert = new AlertDialog.Builder(MainRegisterActivity.this).setTitle("温馨提示")
                        ...
                        alert.show();
                    } else if (!input_question.ifAlready()) {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_bottom1:
                // 修改代码
//                Intent intent = new Intent(MainRegisterActivity.this, MainLoginActivity.class);
//                startActivity(intent);
                finish();
                break;
            case R.id.tv_school0:
                try {
                    Intent intent1 = new Intent(MainRegisterActivity.this, MainRegisterListView.class);
            ...
            case R.id.tv_faculty0:
                try {
                    Intent intent2 = new Intent(MainRegisterActivity.this, MainRegisterListView.class);
            ...
            case R.id.tv_year0:
                try {
                    Intent intent3 = new Intent(MainRegisterActivity.this, MainRegisterListView.class);
            ...
            case R.id.tv_position0:
                ...
                AlertDialog.Builder bd = new AlertDialog.Builder(MainRegisterActivity.this);
            ...
            case R.id.tv_degree0:
                ...
                AlertDialog.Builder bd1 = new AlertDialog.Builder(MainRegisterActivity.this);
            ...
            case R.id.tv_sex0:
                ...
                AlertDialog.Builder bd2 = new AlertDialog.Builder(MainRegisterActivity.this);
    ...
    public void initView() {
        ar_titleLayout.setTitle("注册新用户");
        submitRegister = ar_titleLayout.getSettingButton();
        submitRegister.setText("提交");
        submitRegister.setOnClickListener(view -> submitFinalRegisterInfo());
        checknum = -1;
        checknum1 = -1;
        checknum2 = -1;

        input_question.setHintText("问题：", "请输入问题", "输入问题！", "用以找回密码和修改密码");
        input_answer.setHintText("答案：", "请输入答案", "输入答案！", "请务必记住答案！");
    ...
    public void submit() {
        ...
        user.setQuestion(input_question.getFinalInputText());
        user.setAnswer(input_answer.getFinalInputText());
        user.setMd5_password(addSalt(ed_password.getText().toString()));
        ...
        //发送post请求注册
        String after = Constant.REGISTER_URL;
        ...
        sendPostRequest(after, json, new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                log(thisClass, "发送请求失败，请检查网络" + e.getMessage());
            }
            ...
            public void run() {
                ...
                if (finishState == true || failState == true) {
                    if (finishState == true) {
                        ...
                        Toast.makeText(MainRegisterActivity.this, "注册错误：" + failmsg, Toast.LENGTH_SHORT).show();
                        ed_username.setText("");
                        failState = false;
                        myhandler.removeCallbacks(updateThread);
                    }
