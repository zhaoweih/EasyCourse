...
/**
*@description 首页-扫码框布局
*@author
*@time 2019/1/28 14:17
*/
public class HomeScanViewFinderViewLayout extends ViewfinderView {
     ...
     * 线性梯度各个位置对应的颜色值
     */
    public int[] mScanLineColor = new int[]{Color.WHITE,Color.WHITE, Color.WHITE};


    public HomeScanViewFinderViewLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
